...
<h1 className="text-2xl text-gray-800 text-center pb-6 font-bold">Factonial n!</h1>
...
<div className="fixed bottom-4 right-2 z-10  shadow-lg">
    <Link to="/" className="bg-blue-400 py-3 px-6 text-white rounded-full "> Volver a la lista </Link></div>
           ...
           {error}
            ...
            <span className="block text-xl text-gray-700 font-bold py-3">{result.toLocaleString('es-ES')}</span>
